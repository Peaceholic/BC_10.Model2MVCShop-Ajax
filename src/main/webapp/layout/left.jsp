		 ...
		 $(function() {
			...
			//==> DOM Object GET 3가지 방법 ==> 1. $(tagName) : 2.(#id) : 3.$(.className)
		 	...
		 	$("#Developer").on("click" , function() {
		 		DeveloperWin();
	 			/* $(window.parent.frames["rightFrame"].document.location).attr("href","http://bftest.wecode.co.kr/"); */
			}); 
		 	
		 	$("#MBTI").on("click" , function() {
		 		MBTIWin();
				/* $(window.parent.frames["rightFrame"].document.location).attr("href","https://www.16personalities.com/ko/"); */
			});
		 	
		 	$("#HOME").on("click" , function() {
				$(window.parent.frames["rightFrame"].document.location).attr("href","http://127.0.0.1:8080/");
			}); 
