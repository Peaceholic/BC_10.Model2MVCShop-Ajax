...
function updatePurchase(currentPage) {
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td id="send" background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
				...
				<td id="back" background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
